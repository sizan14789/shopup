...
export default function CardForSlider({data}: {data:ProductCardType }) {
  ...
  return (
    <div className="flex flex-col border border-(--border) rounded-md   p-4 pb-6 grow hover:border-(--primary) duration-200 group cursor-pointer"
